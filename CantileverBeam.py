...
# Config Details: Differential A0-A1, PGA = +/-4.096V, Continuous Mode, 128 SPS
# Binary: 0000 0010 1000 0100 -> 0x0284
CONFIG_DIFF_A0_A1_2_048V = 0x0284
LSB_SIZE = 4.096 / 32768 # 16-bit signed resolution step size
